...
const LandingPage = () => {
  ...
  return (
    <div className="bg-background text-foreground min-h-screen font-sans transition-colors duration-300">
      <ThemeToggle className="fixed top-4 right-4 z-[100] shadow-lg" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <div>
                <span className="text-2xl font-bold text-foreground tracking-tight">Vishwakarma</span>
                <span className="ml-1 text-indigo-600 font-semibold text-sm uppercase tracking-wider">Workshop</span>
              </div>
            </div>
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#features" className="text-sm font-medium text-muted-foreground hover:text-indigo-600 transition-colors">Features</a>
              <a href="#pricing" className="text-sm font-medium text-muted-foreground hover:text-indigo-600 transition-colors">Pricing</a>
              <LoginModal trigger={
                <button className="text-sm font-medium text-muted-foreground hover:text-indigo-600 transition-colors cursor-pointer bg-transparent border-none">
                  Sign In
                </button>
              } />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-12 lg:gap-16 items-center">
            <div className="sm:text-center md:max-w-2xl md:mx-auto lg:col-span-6 lg:text-left space-y-8">
              <div className="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-indigo-500/10 text-indigo-400 ring-1 ring-inset ring-indigo-400/20">
                Now in Public Beta
              </div>
              <h1 className="text-5xl tracking-tight font-extrabold text-foreground sm:text-6xl md:text-7xl">
                The OS for your <br />
                <span className="text-indigo-500">Mechanical Workshop</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:justify-center lg:justify-start">
                ...
                <Button variant="outline" size="lg" className={cn("hover:bg-accent text-foreground px-8 py-6 text-lg")}>
                  <a href="#features">View Demo</a>
                </Button>
              </div>
            </div>
            <div className="mt-16 lg:mt-0 lg:col-span-6">
              <div className="relative mx-auto w-full rounded-2xl shadow-2xl overflow-hidden bg-card ring-1 ring-border p-2 transform hover:scale-[1.02] transition-transform duration-500">
                <img 
      ...
      {/* Features Section */}
      <section id="features" className="py-24 bg-card scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-20 space-y-4">
            <h2 className="text-indigo-400 font-bold tracking-wider uppercase text-sm">Capabilities</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-foreground">Vishwakarma</span>
            </div>
            ...
            <div className="flex gap-6">
              ...
              <a href="#" className="text-muted-foreground hover:text-indigo-600 transition-colors">
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.227 1.664 4.771 4.919-4.919 1.266.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.058-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
              </a>
            </div>
          </div>
        </div>
...
const FeatureCard = ({ icon, title, description }) => (
  <div className="p-8 border border-border rounded-2xl bg-card hover:shadow-xl hover:-translate-y-1 transition-all duration-300">
    <div className="bg-indigo-600 w-12 h-12 rounded-xl flex items-center justify-center mb-6 shadow-lg shadow-indigo-200/20">
      {icon}
    </div>
