...
const StatsCard = ({ title, value, icon, trend, link }) => {
    const cardContent = (
        <Card className="group relative overflow-hidden bg-card border-border hover:border-emerald-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-emerald-500/5 hover:-translate-y-1 [--stats-hover-emerald:#059669] dark:[--stats-hover-emerald:#34d399]">
            <CardContent className="p-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    <div className="p-2 rounded-lg bg-muted text-muted-foreground group-hover:text-[color:var(--stats-hover-emerald)] group-hover:bg-emerald-500/10 transition-all">
                        {icon}
                    </div>
                </div>
